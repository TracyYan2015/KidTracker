...
{
    NSString* s = transaction.originalTransaction.payment.productIdentifier;
    std::string ss = [s UTF8String];
    
    _iosiap->delegate->purchasedProducts(ss);
...
void IOSiAP::restoreTransactions(void)
{
